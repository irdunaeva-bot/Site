  ...
  return (
    <section id="pricing" className="py-20 sm:py-24 bg-slate-50/70 border-b border-slate-200/80">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-7">
          ...
          {products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="flex flex-col rounded-3xl border border-slate-200 bg-white p-6 sm:p-7 hover:border-slate-300 hover:shadow-lg transition-all shadow-xs"
              >
                {/* Category & Name */}
                <div className="mb-4">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mt-2.5 font-['Space_Grotesk']">
                    {product.name[lang]}
                  </h3>
                ...
                {/* Price Display */}
                <div className="rounded-2xl bg-slate-50 border border-slate-200/80 p-4 mb-6">
                  <div className="flex items-baseline gap-1">
                    <span className="text-3xl font-extrabold text-slate-900">{finalAmount}</span>
                ...
                {/* Features list */}
                <div className="space-y-2.5 text-xs text-slate-600 mb-6 flex-grow">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-slate-100 py-3.5 text-xs font-bold text-slate-800 hover:bg-blue-600 hover:text-white hover:border-blue-600 shadow-xs transition-colors"
                >
          ...
          <div className="relative flex flex-col rounded-3xl border-2 border-blue-600 bg-gradient-to-b from-blue-50/70 via-white to-white p-6 sm:p-7 shadow-xl shadow-blue-500/10">
            {/* Top Badge */}
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-1 text-[11px] font-extrabold text-white shadow-md uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div className="mb-4 mt-2">
              ...
              <h3 className="text-xl font-bold text-slate-900 mt-2 font-['Space_Grotesk']">
            ...
            {(() => {
              ...
              return (
                <>
                  <div className="rounded-2xl bg-blue-100/60 border border-blue-200 p-4 mb-6">
                    <div className="flex items-baseline gap-1">
                      <span className="text-3xl font-extrabold text-blue-700">{bundleTotal}</span>
                  ...
                  {/* Features list */}
                  <div className="space-y-2.5 text-xs text-slate-700 mb-6 flex-grow font-medium">
                    <div className="flex items-start gap-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 py-3.5 text-xs font-bold text-white shadow-lg shadow-blue-500/25 hover:from-blue-700 hover:to-indigo-700 transition-all"
                  >
        ...
        <div className="mt-12 rounded-3xl border border-slate-200 bg-white p-5 text-center flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 shadow-xs">
          ...
          <div className="flex items-center gap-3 font-bold text-slate-600">
            ...
            <span className="px-2 py-1 rounded bg-slate-100">Apple Pay</span>
            <span className="px-2 py-1 rounded bg-slate-100">Google Pay</span>
            <span className="px-2 py-1 rounded bg-slate-100">{lang === 'uk' ? 'Приват24' : 'Privat24'}</span>
          </div>
        </div>
      </div>
    </section>
