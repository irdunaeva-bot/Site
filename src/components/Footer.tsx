  ...
  return (
    <footer id="contacts" className="border-t border-slate-200 bg-slate-50 text-slate-600 text-xs w-full max-w-full overflow-hidden">
      ...
      <div id="company-info" className="mx-auto max-w-7xl px-3.5 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-10 sm:mb-12">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-slate-900">
              ...
              <span className="text-lg font-extrabold font-['Space_Grotesk']">
                RECREATE
              </span>
            </div>
            ...
            <div className="inline-block rounded-lg bg-white border border-slate-200 px-3 py-1 text-slate-800 font-mono text-xs font-bold shadow-2xs">
              {t.footer.edrpou}
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 space-y-2 shadow-xs">
              ...
              <div className="flex flex-wrap gap-1.5 text-[10px] font-bold text-slate-600 pt-1 border-t border-slate-100">
                <span className="bg-slate-100 px-2 py-0.5 rounded">Visa</span>
                <span className="bg-slate-100 px-2 py-0.5 rounded">Mastercard</span>
                <span className="bg-slate-100 px-2 py-0.5 rounded">Apple Pay</span>
                <span className="bg-slate-100 px-2 py-0.5 rounded">Google Pay</span>
                <span className="bg-slate-100 px-2 py-0.5 rounded">Privat24</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 pt-6 flex flex-wrap items-center justify-between gap-4 text-xs">
